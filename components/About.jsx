...
const InfoData = [
  ...
  },
  {
    ...
    text: "surajaidee01@gamil.com",
  },
  {
    icon: <Calendar size={20} />,
    text: "Born on 24 Feb, 2000",
  },
  {
  ...
  },
  {
    ...
    text: "Shukhlaphanta 01, Kanchanpur, Nepal",
  },
];
    ...
    data: [
      {
        ...
        qualification: "Intermediate in Science",
        years: "2016 - 2018",
      },
      {
            ...
            <div className="text-lg mt-12 xl:mt-8">
              ...
              <TabsContent value="personal">
                <div className="">
                  ...
                  <p className="subtitle max-w-xl max-auto xl:mx-0">
                    I specialize in crafting inttive websites with cutting-edge
                  ...
                  <div className="flex flex-col gap-y-2">
                    ...
                    <div className="">
                      Nepali, English, Sudurpaschimeli, Hindi
                    </div>
                  </div>
                </div>
              </TabsContent>
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <div className="flex flex-col gap-y-8">
                        {getData(qualificationData, "education").data.map(
                          (item, index) => {
                            const { school, university, qualification, years } =
                              item;
                            return (
                              <div key={index} className="flex gap-x-8 group">
                                <div className="h-[84px] w-[1px] bg-border relative ml-2">
              ...
              <TabsContent value="skills">
                <div className="text-center xl:text-left">
                  ...
                  {/* tools */}
                  <div className="">
                    <h4 className="text-xl font-semiboldmv-2 xl:text-left">
                      Tools
                    </h4>
                    <div className="border-b border-border mb-4"></div>
                    {/* tool list */}
